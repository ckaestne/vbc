...
import edu.cmu.cs.vbc.prog.checkstyle.grammars.GeneratedJavaLexer;
import edu.cmu.cs.vbc.prog.checkstyle.grammars.GeneratedJavaRecognizer;
    ...
    extends AbstractFileSetCheck
{
	...
	@VConditional
	private static boolean TW = true;
