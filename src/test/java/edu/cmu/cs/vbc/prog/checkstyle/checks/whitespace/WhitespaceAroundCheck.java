...
public class WhitespaceAroundCheck extends Check
{
	...
	@VConditional
	private static boolean WhitespaceAround = true;
	
	@Override
	public boolean isEnabled() {
		return WhitespaceAround;
	}
    /**
    ...
    @VConditional
    private static boolean WhitespaceAroundAllowEmptyCtors = true;
    /** Whether or not empty method bodies are allowed. */
    
    @VConditional
    private static final boolean WhitespaceAroundAllowEmptyMethods = true;
    /** Whether or not empty classes, enums and interfaces are allowed*/
    @VConditional
    private static final boolean WhitespaceAroundAllowEmptyTypes = true;
    /** Whether or not empty loops are allowed*/
    @VConditional
    private static final boolean WhitespaceAroundAllowEmptyLoops = true;
    /** whether or not to ignore a colon in a enhanced for loop */
    @VConditional
    private static final boolean WhitespaceAroundIgnoreEnhancedForColon = true;
    ...
    {
//        WhitespaceAroundAllowEmptyMethods = allow;
    }
    ...
    {
//        WhitespaceAroundAllowEmptyCtors = allow;
    }
    ...
    {
//        WhitespaceAroundIgnoreEnhancedForColon = ignore;
    }
    ...
    {
//        WhitespaceAroundAllowEmptyTypes = allow;
    }
    ...
    {
//        WhitespaceAroundAllowEmptyLoops = allow;
    }
    ...
    public void visitToken(DetailAST ast)
    {
        ...
        if ((currentType == TokenTypes.COLON)) {
                ...
                || parentType == TokenTypes.LITERAL_CASE)
            {
                ...
                && this.WhitespaceAroundIgnoreEnhancedForColon)
            {
                return;
            }
        }
        ...
        if (WhitespaceAroundAllowEmptyTypes && (isEmptyType(ast, parentType))) {
            return;
        }
    ...
    {
        return WhitespaceAroundAllowEmptyMethods
    ...
    {
        return WhitespaceAroundAllowEmptyCtors
    ...
    {
        return WhitespaceAroundAllowEmptyLoops
