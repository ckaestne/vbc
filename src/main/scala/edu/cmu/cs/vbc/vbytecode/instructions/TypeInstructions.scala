...
case class InstrF2I() extends UnaryOpInstruction(F2I, "f2i", INT_TYPE())
case class InstrF2L() extends UnaryOpInstruction(F2L, "f2l", LONG_TYPE())
case class InstrD2I() extends UnaryOpInstruction(D2I, "d2i", INT_TYPE())
