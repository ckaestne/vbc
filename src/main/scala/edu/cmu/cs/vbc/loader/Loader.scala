...
class Loader {
  ...
  def adaptBytecodeInstruction(inst: AbstractInsnNode, labelLookup: LabelNode => Int, variables: (Int, Int) => Variable): Instruction =
    inst.getOpcode match {
      ...
      case FCONST_0 => InstrFCONST(FCONST_0)
      case FCONST_1 => InstrFCONST(FCONST_1)
      case FCONST_2 => InstrFCONST(FCONST_2)
      case DCONST_0 => InstrDCONST(DCONST_0)
      case DCONST_1 => InstrDCONST(DCONST_1)
      case BIPUSH => {
